    ...
    return (
        <div className="dark:bg-white-800">
            ...
            <div className="flex items-center justify-center ">
                <div className="flex items-center justify-center flex-col md:flex-row bg-white shadow-lg rounded-2xl p-6 md:p-10 max-w-6xl mx-auto shadow-lg shadow-black-500">
                    {/* Left Side - Image */}
